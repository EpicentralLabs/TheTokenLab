...
async function main() {
    ...
    const mintToTxId = await (0, compressed_token_1.mintTo)(connection, payer, // Fee payer
    mint, // Mint address
    ...
    const transferTxId = await (0, compressed_token_1.transfer)(connection, payer, // Fee payer
    mint, // Mint address
