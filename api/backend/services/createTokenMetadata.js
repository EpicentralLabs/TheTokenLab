...
async function createMetadata(tokenName, tokenSymbol, userPublicKeyInstance, updatedMetadataUri, payer, parsedDecimals, quantity, freezeChecked, mintChecked, immutableChecked, tokenMintAccount) {
    ...
    const updateAuthority = !immutableChecked ? user.publicKey : web3_js_1.PublicKey.default;
