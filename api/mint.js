...
const createTokenMetadata_1 = require("./createTokenMetadata");
...
const validateRequiredFields = (reqBody) => {
    const missingFields = [];
    const requiredFields = ['tokenName', 'tokenSymbol', 'quantity', 'mintChecked', 'immutableChecked', 'decimals', 'paymentType', 'imagePath'];
...
router.post('/', async (req, res) => {
    const { tokenName, tokenSymbol, userPublicKey, quantity, mintChecked, immutableChecked, decimals, paymentType, imagePath, } = req.body;
    ...
    try {
        ...
        let transactionLink;
        try {
            transactionLink = await (0, createTokenMetadata_1.createMetadata)(tokenName, tokenSymbol, userPublicKeyInstance, updatedMetadataUri, payer.publicKey, parsedDecimals, quantity, mintChecked, immutableChecked, tokenMintAccount);
        ...
        try {
            ...
            if (mintChecked) {
                ...
                try {
                    ...
                    await (0, spl_token_1.setAuthority)(connection, payer, tokenMintAccount, payer, spl_token_1.AuthorityType.FreezeAccount, null);
            ...
            else {
                {
                    ...
                    await (0, spl_token_1.setAuthority)(connection, payer, tokenMintAccount, payer.publicKey, spl_token_1.AuthorityType.MintTokens, userPublicKeyInstance);
