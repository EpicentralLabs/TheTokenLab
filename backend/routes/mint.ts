...
import { createTokenMint } from '../services/createTokenMint';
import { createTokenMetadata } from '../services/createTokenMetadata';
...
router.post('/', async (req: Request, res: Response) => {
    ...
    try {
        ...
        try {
            const mintAddress = await createTokenMint(quantity, payer);
        ...
        const metadataResult = await createTokenMetadata(mintPublicKey, {
            name: tokenName,
            symbol: tokenSymbol,
