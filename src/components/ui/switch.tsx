...
const Switch = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SwitchPrimitives.Root> & { onToggle?: (checked: boolean) => void }
>(({ className, onToggle, ...props }, ref) => {
  ...
  return (
    <SwitchPrimitives.Root
      ...
      className={cn(
        "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00FFA3] focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-[#00FFA3] data-[state=unchecked]:bg-gray-600",
        className || ""
      )}
      {...props}
      ref={ref}
