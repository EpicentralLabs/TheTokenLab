...
// Define the props interface for the TokenNameList component
interface TokenNameListProps {
    tokenName: string;
...
const TokenNameList: React.FC<TokenNameListProps> = ({ tokenName, setTokenName, isError }) => {
